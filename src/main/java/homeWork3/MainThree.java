...
public class MainThree {
    ...
    public static void main(String[] args) {
        ...
        String str = "Иванов Иван Иванович 1969-02-02 89845681523 m";
        String str1 = "Петров Петр Петрович 1982-12-05 89575486525 m";
        PersonValide personValide = new PersonValide(validator);
        Person person = personValide.personCreate(str);
        FileWriterPerson fileWriterPerson = new FileWriterPerson();
        fileWriterPerson.fileWriter(person);
    }
}
